                            ...
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-md-3 form-group">
                                        ...
                                        <input type="text" name="descricao" id="input-name" class="form-control form-control-alternative" placeholder="" required>
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <label class="form-control-label" for="input-name">{{ __('Código') }}</label>
                                        <input type="text" name="codigo" id="input-name" class="form-control form-control-alternative" placeholder="" required>
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <label class="form-control-label" for="input-name">{{ __('UN') }}</label>
                                        <input type="text" name="un" id="input-name" class="form-control form-control-alternative" value="UN" placeholder="Ex: UN" required>
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <label class="form-control-label" for="input-name">{{ __('Preço') }}</label>
                                        <input type="text" name="preco" id="input-name" class="form-control form-control-alternative" placeholder="" required>
                                    </div>
                                </div>
